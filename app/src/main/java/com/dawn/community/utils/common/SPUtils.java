...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = CommunityApplication.getContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = CommunityApplication.getContext().getSharedPreferences(spName, mode);
    }
